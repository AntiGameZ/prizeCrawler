...
public class QXC500wan implements IAgency{

	private static Logger logger = LoggerFactory.getLogger(QXC500wan.class);
	private static final String URL = "http://kaijiang.500.com/static/info/kaijiang/xml/qxc/list.xml";
	...
	public PrizeInfo crawlFromAgency(String lotno, String batchcode) {
		...
		try {
			logger.info("开始从500万抓取开奖,彩种T01009,期号"+batchcode);
			...
			logger.info("从五百万抓取第" + batchcode + "期七星彩开奖出错", e);
		}
	...
	public static void main(String[] args) {
		System.out.println(new QXC500wan().crawlFromAgency("T01009", "2012151"));
	}
