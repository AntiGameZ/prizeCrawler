...
public class DLT500wan implements IAgency{

	private static Logger logger = LoggerFactory.getLogger(DLT500wan.class);
	private static final String URL = "http://kaijiang.500.com/static/info/kaijiang/xml/dlt/list.xml";
	...
	public PrizeInfo crawlFromAgency(String lotno, String batchcode) {
		...
		try {
			logger.info("开始从500万抓取开奖,彩种T01001,期号"+batchcode);
			...
			for(Element e:eles) {
				if(batchcode.equals("20"+e.attr("expect"))) {
					...
					prizeInfo.setWinbasecode(e.attr("opencode").replace(",", " ").replace("|", "+"));
			...
			logger.info("从五百万抓取第" + batchcode + "期大乐透开奖出错", e);
		}
	...
	public static void main(String[] args) {
		System.out.println(new DLT500wan().crawlFromAgency("T01010","2012150"));
	}
}
