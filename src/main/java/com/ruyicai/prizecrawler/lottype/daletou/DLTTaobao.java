...
public class DLTTaobao implements IAgency{

	private static Logger logger = LoggerFactory.getLogger(DLTTaobao.class);
	private static final String URL = "http://caipiao.taobao.com/lottery/awardresult/lottery_dlt.htm";
	...
	public static void main(String[] args) {
		System.out.println(new DLTTaobao().crawlFromAgency("T01010","2012150"));
	}
