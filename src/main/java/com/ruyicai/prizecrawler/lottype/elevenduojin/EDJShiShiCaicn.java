...
public class EDJShiShiCaicn {

	private static Logger logger = LoggerFactory.getLogger(EDJShiShiCaicn.class);
	private static final String URLCookie = "http://data.shishicai.cn/sd11x5/haoma/";
	...
	public PrizeInfo carwlFromFromShiShiCaicnByBatchcode(String batchcode) {
		...
		try {
			logger.info("开始从shishicai.cn抓取T01012开奖:期号"+batchcode);
			String cookie = HttpTookit.getWebSiteCookie(URLCookie);
			Map<String,String> params = new HashMap<String, String>();
			params.put("date", "0001-01-01");
			params.put("lottery", "16");
			
			Map<String,String> requestProperties = new HashMap<String, String>();
			requestProperties.put("Referer", "http://data.shishicai.cn/sd11x5/haoma/");
			...
			if(opencodeMap.containsKey("20"+batchcode)) {
				prizeInfo.setBatchcode(batchcode);
				prizeInfo.setLotno("T01012");
				prizeInfo.setWinbasecode(opencodeMap.get("20"+batchcode));
				prizeInfo.setWinspecialcode("");
			}
			
			logger.info("从shishicai.cn抓取T01012开奖结束:期号"+batchcode+"prizeInfo:"+prizeInfo.toString());
			
		} catch (Exception e) {
			prizeInfo = new PrizeInfo();
			logger.info("从shishicai.cn抓取T01012开奖出错:期号"+batchcode, e);
		}
	...
	public static void main(String[] args) {
		System.out.println(new EDJShiShiCaicn().carwlFromFromShiShiCaicnByBatchcode("13011729"));
