...
@Service("T01012")
public class ElevenDuoJin extends AbstractLottype{
	...
	private EDJ360 edj360 = new EDJ360();
	private EDJJincaizi jincaizi = new EDJJincaizi();
	private EDJHuaCai huacai = new EDJHuaCai();
	private EDJShiShiCaicn shishicaicn = new EDJShiShiCaicn();
	...
	public void crawl(PrizeInfo prizeInfo) {
		...
		try {
			...
			PrizeInfo p1 = edj360.carwlFrom360ByBatchcode(prizeInfo
					.getBatchcode());
			PrizeInfo p2 = shishicaicn.carwlFromFromShiShiCaicnByBatchcode(prizeInfo
					.getBatchcode());
			PrizeInfo p3 = jincaizi.carwlFromJincaiziByBatchcode(prizeInfo
					.getBatchcode());
			PrizeInfo p4 = huacai.carwlFromHuaCaiByBatchcode(prizeInfo
					.getBatchcode());
			if (p1.equals(p2)) {
