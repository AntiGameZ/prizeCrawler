...
public class PLSOkooo implements IAgency{

	private static Logger logger = LoggerFactory.getLogger(PLSOkooo.class);
	private static final String URL = "http://www.okooo.com/p3/p3kj/";
	...
	public PrizeInfo crawlFromAgency(String lotno, String batchcode) {
		...
		try {
			logger.info("开始从澳客抓取开奖,彩种T01002,期号"+batchcode);
			...
			logger.info("从澳客抓取第" + batchcode + "期排列三开奖出错", e);
		}
	...
	public static void main(String[] args) {
		System.out.println(new PLSOkooo().crawlFromAgency("T01002", "2012351"));
	}
