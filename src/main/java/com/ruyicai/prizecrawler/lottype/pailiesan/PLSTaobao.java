...
public class PLSTaobao implements IAgency{

	private static Logger logger = LoggerFactory.getLogger(PLSTaobao.class);
	private static final String URL = "http://caipiao.taobao.com/lottery/awardresult/lottery_p3.htm";
	...
	private void buildPrizeInfo(String batchcode, PrizeInfo prizeInfo,
		...
		String wincode = winnum[0]+winnum[1]+winnum[2];
	...
	public static void main(String[] args) {
		System.out.println(new PLSTaobao().crawlFromAgency("T01002", "2012351"));
	}
