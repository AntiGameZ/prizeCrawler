...
//暂时不可用
public class Gd115xuan5 {

	private static Logger logger = LoggerFactory.getLogger(Gd115xuan5.class);
	private static final String URL = "http://zoushi.11xuan5.cn/gd/haoma/70.aspx";

	public PrizeInfo carwlFrom11xuan5ByBatchcode(String batchcode) {
		PrizeInfo prizeInfo = new PrizeInfo();
		try {
			logger.info("开始从11xuan5抓取T01014开奖:期号" + batchcode);
			...
			logger.info("从11xuan5抓取T01014开奖结束:期号" + batchcode + "prizeInfo:"
					+ prizeInfo.toString());
		} catch (Exception e) {
			prizeInfo = new PrizeInfo();
			logger.info("从11xuan5抓取T01014开奖出错:期号" + batchcode, e);
		}
		return prizeInfo;
	...
	public static void main(String[] args) {
		System.out.println(new Gd115xuan5().carwlFrom11xuan5ByBatchcode("2012122411"));
	}
